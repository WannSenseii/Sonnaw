...
<div id="settingsBoot" class="settings-card liquid">
<p>Loading Settings...</p>
</div>

<div id="settingsLogin" class="settings-card liquid" style="display:none;">
<h1>Sign in</h1>
...
<button class="settings-menu-item liquid" onclick="openNavigationSettings()">
  <div>
    <h3>Navigation</h3>
    <p id="navigationSettingDesc">Gesture Navigation</p>
  </div>
  <span>›</span>
</button>

<button class="settings-menu-item liquid" onclick="toggleWannDarkMode()">
  <div>
    <h3 id="darkModeSettingTitle">Dark Mode</h3>
    <p id="darkModeSettingDesc">Switch WannUI to darker interface</p>
  </div>
  <span id="darkModeSettingIcon">☾</span>
</button>
...
<div id="navigationPage" class="settings-subpage" style="display:none;">

<button class="settings-back-small" onclick="backToSettingsHome()">← Settings</button>

<div class="settings-card liquid">
<h1>Navigation</h1>
<p>Choose how to control WannUI.</p>

<button onclick="setNavigationMode('gesture')">
Gesture Navigation
</button>

<button onclick="setNavigationMode('3button')">
3 Button Navigation
</button>
...
const boot =
document.getElementById("settingsBoot");
...
window.openNavigationSettings = function(){
...
function updateNavigationSettingText(){

const desc =
document.getElementById("navigationSettingDesc");

if(!desc) return;

const mode =
localStorage.getItem("wannuiNavigationMode") || "gesture";
